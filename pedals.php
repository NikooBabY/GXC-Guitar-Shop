...
<body>
    ...
    <div class="container">
        ...
        <?php 
            $pro = "SELECT * FROM products2 P WHERE P.instruments = 'Pedals'";
            $result = $conn->query($pro);
            while($data = $result->fetch_assoc()){ ?>
            
                <div class="col-md-3" style="font-family: 'Oswald', sans-serif; text-align: center;  margin-top: 20px;" >
                <div class="card">
                <a href="singleprodisp.php?id=<?php echo $data['id'] ?>"><p><img src="Product_images/<?php echo $data['newproimage']; ?>" class="img-thumbnail" style="height: 400px; border:0px;" /></p></a>
